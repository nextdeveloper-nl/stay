...
class ProductGroupsObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\Stay\ProductGroups', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\Stay\ProductGroups', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\Stay\ProductGroups', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\Stay\ProductGroups', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\Stay\ProductGroups', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\Stay\ProductGroups', $model);
    }
