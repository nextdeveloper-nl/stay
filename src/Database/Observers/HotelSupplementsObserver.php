...
/**
 * Class HotelSupplementsObserver
 *
...
class HotelSupplementsObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\Stay\HotelSupplements', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\Stay\HotelSupplements', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\Stay\HotelSupplements', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\Stay\HotelSupplements', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\Stay\HotelSupplements', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\Stay\HotelSupplements', $model);
    }
