...
/**
 * Class MainPurchaseContractsObserver
 *
...
class MainPurchaseContractsObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\Stay\MainPurchaseContracts', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\Stay\MainPurchaseContracts', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\Stay\MainPurchaseContracts', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\Stay\MainPurchaseContracts', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\Stay\MainPurchaseContracts', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\Stay\MainPurchaseContracts', $model);
    }
