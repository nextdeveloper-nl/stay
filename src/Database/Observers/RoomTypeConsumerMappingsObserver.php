...
/**
 * Class RoomTypeConsumerMappingsObserver
 *
...
class RoomTypeConsumerMappingsObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\Stay\RoomTypeConsumerMappings', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\Stay\RoomTypeConsumerMappings', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\Stay\RoomTypeConsumerMappings', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\Stay\RoomTypeConsumerMappings', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\Stay\RoomTypeConsumerMappings', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\Stay\RoomTypeConsumerMappings', $model);
    }
