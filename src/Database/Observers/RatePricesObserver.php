...
class RatePricesObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\Stay\RatePrices', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\Stay\RatePrices', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\Stay\RatePrices', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\Stay\RatePrices', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\Stay\RatePrices', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\Stay\RatePrices', $model);
    }
