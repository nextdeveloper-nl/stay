...
class RatesObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\Stay\Rates', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\Stay\Rates', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\Stay\Rates', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\Stay\Rates', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\Stay\Rates', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\Stay\Rates', $model);
    }
