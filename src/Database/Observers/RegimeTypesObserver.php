...
class RegimeTypesObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\Stay\RegimeTypes', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\Stay\RegimeTypes', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\Stay\RegimeTypes', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\Stay\RegimeTypes', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\Stay\RegimeTypes', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\Stay\RegimeTypes', $model);
    }
