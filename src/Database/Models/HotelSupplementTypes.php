...
use NextDeveloper\Stay\Database\Observers\HotelSupplementTypesObserver;
use NextDeveloper\Commons\Database\Traits\UuidId;
use NextDeveloper\Commons\Common\Cache\Traits\CleanCache;
use NextDeveloper\Commons\Database\Traits\Taggable;

/**
 * HotelSupplementTypes model.
 *
 ...
 * @property string $maintenance_control
...
class HotelSupplementTypes extends Model
{
    ...
    public static function boot()
    {
        ...
        parent::observe(HotelSupplementTypesObserver::class);
    ...
    public static function registerScopes()
    {
        ...
        $modelScopes = config('stay.scopes.stay_hotel_supplement_types');
