...
use NextDeveloper\Stay\Database\Observers\OfferSupplementTypesObserver;
use NextDeveloper\Commons\Database\Traits\UuidId;
use NextDeveloper\Commons\Common\Cache\Traits\CleanCache;
use NextDeveloper\Commons\Database\Traits\Taggable;

/**
 * OfferSupplementTypes model.
 *
...
class OfferSupplementTypes extends Model
{
    ...
    public static function boot()
    {
        ...
        parent::observe(OfferSupplementTypesObserver::class);
    ...
    public static function registerScopes()
    {
        ...
        $modelScopes = config('stay.scopes.stay_offer_supplement_types');
