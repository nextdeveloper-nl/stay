 ...
 */
class SupplementTypesQueryFilter extends AbstractQueryFilter
{
    ...
    public function controlMaintenance($value)
    {
        return $this->builder->where('control_maintenance', 'like', '%' . $value . '%');
    }
