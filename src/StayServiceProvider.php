 ...
 */
class StayServiceProvider extends AbstractServiceProvider
{
    /**
     * @var bool
     */
    ...
    public function boot()
    {
        $this->publishes(
            [
            __DIR__.'/../config/stay.php' => config_path('stay.php'),
            ], 'config'
        );

        $this->loadViewsFrom($this->dir.'/../resources/views', 'Stay');
    ...
    public function register()
    {
        ...
        $this->mergeConfigFrom(__DIR__.'/../config/stay.php', 'stay');
