 ...
 */
class AbstractRoomTypeProviderMappingsTransformer extends AbstractTransformer
{
    ...
    public function transform(RoomTypeProviderMappings $model)
    {
        ...
        return $this->buildPayload(
            ...
            'provider_room_type_code'  =>  $model->provider_room_type_code,
            ]
        );
    }

    public function includeStates(RoomTypeProviderMappings $model)
    {
    ...
    public function includeActions(RoomTypeProviderMappings $model)
    {
    ...
    public function includeMedia(RoomTypeProviderMappings $model)
    {
    ...
    public function includeSocialMedia(RoomTypeProviderMappings $model)
    {
    ...
    public function includeComments(RoomTypeProviderMappings $model)
    {
    ...
    public function includeVotes(RoomTypeProviderMappings $model)
    {
    ...
    public function includeMeta(RoomTypeProviderMappings $model)
    {
    ...
    public function includePhoneNumbers(RoomTypeProviderMappings $model)
    {
    ...
    public function includeAddresses(RoomTypeProviderMappings $model)
    {
