 ...
 */
class AbstractHotelProviderMappingsTransformer extends AbstractTransformer
{
    ...
    public function transform(HotelProviderMappings $model)
    {
        ...
        return $this->buildPayload(
            ...
            'provider_hotel_code'  =>  $model->provider_hotel_code,
            ]
        );
    }

    public function includeStates(HotelProviderMappings $model)
    {
    ...
    public function includeActions(HotelProviderMappings $model)
    {
    ...
    public function includeMedia(HotelProviderMappings $model)
    {
    ...
    public function includeSocialMedia(HotelProviderMappings $model)
    {
    ...
    public function includeComments(HotelProviderMappings $model)
    {
    ...
    public function includeVotes(HotelProviderMappings $model)
    {
    ...
    public function includeMeta(HotelProviderMappings $model)
    {
    ...
    public function includePhoneNumbers(HotelProviderMappings $model)
    {
    ...
    public function includeAddresses(HotelProviderMappings $model)
    {
