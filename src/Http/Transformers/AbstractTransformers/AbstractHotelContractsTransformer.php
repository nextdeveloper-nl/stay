 ...
 */
class AbstractHotelContractsTransformer extends AbstractTransformer
{
    ...
    public function transform(HotelContracts $model)
    {
        ...
        return $this->buildPayload(
            ...
            'quota_block_key'  =>  $model->quota_block_key,
    ...
    public function includeStates(HotelContracts $model)
    {
    ...
    public function includeActions(HotelContracts $model)
    {
    ...
    public function includeMedia(HotelContracts $model)
    {
    ...
    public function includeSocialMedia(HotelContracts $model)
    {
    ...
    public function includeComments(HotelContracts $model)
    {
    ...
    public function includeVotes(HotelContracts $model)
    {
    ...
    public function includeMeta(HotelContracts $model)
    {
    ...
    public function includePhoneNumbers(HotelContracts $model)
    {
    ...
    public function includeAddresses(HotelContracts $model)
    {
