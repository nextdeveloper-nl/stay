 ...
 */
class AbstractAgencyGroupsService
{
    public static function get(AgencyGroupsQueryFilter $filter = null, array $params = []) : Collection|LengthAwarePaginator
    {
        ...
        */
        if($filter == null) {
            $filter = new AgencyGroupsQueryFilter($request);
        }
        ...
        $model = AgencyGroups::filter($filter);
     ...
     * @return mixed
     */
    public static function getByRef($ref) : ?AgencyGroups
    {
        return AgencyGroups::findByRef($ref);
    }

    public static function getActions()
    {
        $model = AgencyGroups::class;
    ...
    {
        $object = AgencyGroups::where('uuid', $objectId)->first();
     ...
     *
     * @param  $id
     * @return AgencyGroups|null
     */
    public static function getById($id) : ?AgencyGroups
    {
        return AgencyGroups::where('id', $id)->first();
    }
    ...
    {
        try {
            $obj = AgencyGroups::where('uuid', $uuid)->first();
    ...
    public static function create(array $data)
    {
        ...
        try {
            $model = AgencyGroups::create($data);
        } catch(\Exception $e) {
            throw $e;
        }

        Events::fire('created:NextDeveloper\Stay\AgencyGroups', $model);
     ...
     * @return AgencyGroups
     */
    public static function updateRaw(array $data) : ?AgencyGroups
    {
    ...
    {
        $model = AgencyGroups::where('uuid', $id)->first();
        ...
        Events::fire('updating:NextDeveloper\Stay\AgencyGroups', $model);
        ...
        Events::fire('updated:NextDeveloper\Stay\AgencyGroups', $model);
    ...
    public static function delete($id)
    {
        ...
        Events::fire('deleted:NextDeveloper\Stay\AgencyGroups', $model);
